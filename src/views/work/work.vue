		...
		<el-container>
			<el-container>
				<el-main style="height: 720px;">
					<ToolBar>
						<div class="main-top">
							<el-breadcrumb-item>工作信息</el-breadcrumb-item>
					...
					<div>
						<el-table ref="multipleTable" :data="listData" tooltip-effect="dark" style="width: 100%">
							...
							<el-table-column label="工作内容" align="center">
								<template slot-scope="scope">{{ scope.row.workDescription }}</template>
								</el-table-column>
								<el-table-column label="工作时间" align="center">
									<template slot-scope="scope">{{ scope.row.workStartDate |formatDate }}</template>
									</el-table-column>
									<el-table-column label="结束时间" align="center">
										<template slot-scope="scope">{{ scope.row.workEndDate |formatDate }}</template>
										</el-table-column>
									<el-table-column label="工作地点" align="center">
										<template slot-scope="scope">{{ scope.row.workLocation }}</template>
										</el-table-column>
						</el-table>
						<ToolBar>
							<div>
